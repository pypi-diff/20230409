# Comparing `tmp/jit_env-0.0.1a0.tar.gz` & `tmp/jit_env-0.0.dev0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "jit_env-0.0.1a0.tar", last modified: Sun Apr  9 13:46:33 2023, max compression
+gzip compressed data, was "jit_env-0.0.dev0.tar", last modified: Fri Apr  7 12:23:25 2023, max compression
```

## Comparing `jit_env-0.0.1a0.tar` & `jit_env-0.0.dev0.tar`

### file list

```diff
@@ -1,23 +1,23 @@
-drwxrwxrwx   0 joery     (1000) joery     (1000)        0 2023-04-09 13:46:33.259562 jit_env-0.0.1a0/
--rwxrwxrwx   0 joery     (1000) joery     (1000)     1062 2023-04-07 11:59:34.000000 jit_env-0.0.1a0/LICENSE
--rwxrwxrwx   0 joery     (1000) joery     (1000)     5026 2023-04-09 13:46:33.259562 jit_env-0.0.1a0/PKG-INFO
--rwxrwxrwx   0 joery     (1000) joery     (1000)     4120 2023-04-08 14:57:27.000000 jit_env-0.0.1a0/README.md
-drwxrwxrwx   0 joery     (1000) joery     (1000)        0 2023-04-09 13:46:33.165777 jit_env-0.0.1a0/jit_env/
--rwxrwxrwx   0 joery     (1000) joery     (1000)     1057 2023-04-07 09:34:23.000000 jit_env-0.0.1a0/jit_env/__init__.py
--rwxrwxrwx   0 joery     (1000) joery     (1000)        0 2023-04-07 12:08:12.000000 jit_env-0.0.1a0/jit_env/_compat_test.py
--rwxrwxrwx   0 joery     (1000) joery     (1000)    12755 2023-04-09 07:14:42.000000 jit_env-0.0.1a0/jit_env/_core.py
--rwxrwxrwx   0 joery     (1000) joery     (1000)     8036 2023-04-09 12:40:20.000000 jit_env-0.0.1a0/jit_env/_core_test.py
--rwxrwxrwx   0 joery     (1000) joery     (1000)    12054 2023-04-09 13:32:14.000000 jit_env-0.0.1a0/jit_env/_specs_test.py
--rwxrwxrwx   0 joery     (1000) joery     (1000)     1666 2023-04-08 14:35:24.000000 jit_env-0.0.1a0/jit_env/_wrappers_test.py
--rwxrwxrwx   0 joery     (1000) joery     (1000)     4046 2023-04-09 13:41:08.000000 jit_env-0.0.1a0/jit_env/compat.py
--rwxrwxrwx   0 joery     (1000) joery     (1000)    21543 2023-04-09 13:40:49.000000 jit_env-0.0.1a0/jit_env/specs.py
--rwxrwxrwx   0 joery     (1000) joery     (1000)      309 2023-04-09 13:46:18.000000 jit_env-0.0.1a0/jit_env/version.py
--rwxrwxrwx   0 joery     (1000) joery     (1000)    12566 2023-04-08 17:03:30.000000 jit_env-0.0.1a0/jit_env/wrappers.py
-drwxrwxrwx   0 joery     (1000) joery     (1000)        0 2023-04-09 13:46:33.243939 jit_env-0.0.1a0/jit_env.egg-info/
--rwxrwxrwx   0 joery     (1000) joery     (1000)     5026 2023-04-09 13:46:32.000000 jit_env-0.0.1a0/jit_env.egg-info/PKG-INFO
--rwxrwxrwx   0 joery     (1000) joery     (1000)      386 2023-04-09 13:46:32.000000 jit_env-0.0.1a0/jit_env.egg-info/SOURCES.txt
--rwxrwxrwx   0 joery     (1000) joery     (1000)        1 2023-04-09 13:46:32.000000 jit_env-0.0.1a0/jit_env.egg-info/dependency_links.txt
--rwxrwxrwx   0 joery     (1000) joery     (1000)      101 2023-04-09 13:46:32.000000 jit_env-0.0.1a0/jit_env.egg-info/requires.txt
--rwxrwxrwx   0 joery     (1000) joery     (1000)        8 2023-04-09 13:46:32.000000 jit_env-0.0.1a0/jit_env.egg-info/top_level.txt
--rwxrwxrwx   0 joery     (1000) joery     (1000)       38 2023-04-09 13:46:33.259562 jit_env-0.0.1a0/setup.cfg
--rwxrwxrwx   0 joery     (1000) joery     (1000)     1902 2023-04-07 12:09:57.000000 jit_env-0.0.1a0/setup.py
...
### Comparing `jit_env-0.0.1a0/LICENSE` & `jit_env-0.0.dev0/LICENSE`

 * *Files identical despite different names*

### Comparing `jit_env-0.0.1a0/PKG-INFO` & `jit_env-0.0.dev0/PKG-INFO`
...
### Comparing `jit_env-0.0.1a0/README.md` & `jit_env-0.0.dev0/jit_env.egg-info/PKG-INFO`
...
### Comparing `jit_env-0.0.1a0/jit_env/__init__.py` & `jit_env-0.0.dev0/jit_env/__init__.py`

 * *Files identical despite different names*

### Comparing `jit_env-0.0.1a0/jit_env/_core.py` & `jit_env-0.0.dev0/jit_env/_core.py`
...
-from jaxtyping import Array, ArrayLike, PyTree, Num, Int8
...
### Comparing `jit_env-0.0.1a0/jit_env/compat.py` & `jit_env-0.0.dev0/jit_env/compat.py`
...
### Comparing `jit_env-0.0.1a0/jit_env/specs.py` & `jit_env-0.0.dev0/jit_env/specs.py`
...
### Comparing `jit_env-0.0.1a0/jit_env/wrappers.py` & `jit_env-0.0.dev0/jit_env/wrappers.py`
...
### Comparing `jit_env-0.0.1a0/jit_env.egg-info/PKG-INFO` & `jit_env-0.0.dev0/README.md`
...
### Comparing `jit_env-0.0.1a0/setup.py` & `jit_env-0.0.dev0/setup.py`
