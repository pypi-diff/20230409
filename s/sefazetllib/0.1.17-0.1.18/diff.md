# Comparing `tmp/sefazetllib-0.1.17.tar.gz` & `tmp/sefazetllib-0.1.18.tar.gz`
...
### Comparing `sefazetllib-0.1.17/sefazetllib/load/LoadLocal.py` & `sefazetllib-0.1.18/sefazetllib/load/LoadLocal.py`
