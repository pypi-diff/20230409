# Comparing `tmp/heart-model-0.0.2.tar.gz` & `tmp/heart-model-0.0.4.tar.gz`
...
### Comparing `heart-model-0.0.2/heart_model/train_pipeline.py` & `heart-model-0.0.4/heart_model/train_pipeline.py`
