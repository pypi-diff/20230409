# Comparing `tmp/hugg-0.0.87.tar.gz` & `tmp/hugg-0.0.88.tar.gz`
...
## Comparing `hugg-0.0.87.tar` & `hugg-0.0.88.tar`
...
### Comparing `hugg-0.0.87/LICENSE` & `hugg-0.0.88/LICENSE`

 * *Files identical despite different names*

### Comparing `hugg-0.0.87/hugg/__init__.py` & `hugg-0.0.88/hugg/__init__.py`
...
### Comparing `hugg-0.0.87/setup.py` & `hugg-0.0.88/setup.py`
