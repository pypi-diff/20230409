# Comparing `tmp/hugg-0.0.80.tar.gz` & `tmp/hugg-0.0.81.tar.gz`
...
## Comparing `hugg-0.0.80.tar` & `hugg-0.0.81.tar`
...
### Comparing `hugg-0.0.80/LICENSE` & `hugg-0.0.81/LICENSE`

 * *Files identical despite different names*

### Comparing `hugg-0.0.80/hugg/__init__.py` & `hugg-0.0.81/hugg/__init__.py`
...
### Comparing `hugg-0.0.80/setup.py` & `hugg-0.0.81/setup.py`
