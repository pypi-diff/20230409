# Comparing `tmp/hugg-0.0.85.tar.gz` & `tmp/hugg-0.0.86.tar.gz`
...
## Comparing `hugg-0.0.85.tar` & `hugg-0.0.86.tar`
...
### Comparing `hugg-0.0.85/LICENSE` & `hugg-0.0.86/LICENSE`

 * *Files identical despite different names*

### Comparing `hugg-0.0.85/hugg/__init__.py` & `hugg-0.0.86/hugg/__init__.py`
...
### Comparing `hugg-0.0.85/setup.py` & `hugg-0.0.86/setup.py`
