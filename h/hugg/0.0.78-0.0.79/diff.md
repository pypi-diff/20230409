# Comparing `tmp/hugg-0.0.78.tar.gz` & `tmp/hugg-0.0.79.tar.gz`
...
## Comparing `hugg-0.0.78.tar` & `hugg-0.0.79.tar`
...
### Comparing `hugg-0.0.78/LICENSE` & `hugg-0.0.79/LICENSE`

 * *Files identical despite different names*

### Comparing `hugg-0.0.78/hugg/__init__.py` & `hugg-0.0.79/hugg/__init__.py`
...
### Comparing `hugg-0.0.78/setup.py` & `hugg-0.0.79/setup.py`
