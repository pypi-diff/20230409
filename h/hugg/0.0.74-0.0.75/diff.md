# Comparing `tmp/hugg-0.0.74.tar.gz` & `tmp/hugg-0.0.75.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "hugg-0.0.74.tar", last modified: Sun Apr  9 06:26:24 2023, max compression
+gzip compressed data, was "hugg-0.0.75.tar", last modified: Sun Apr  9 06:30:11 2023, max compression
```

## Comparing `hugg-0.0.74.tar` & `hugg-0.0.75.tar`

### file list

```diff
@@ -1,14 +1,14 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-09 06:26:24.839536 hugg-0.0.74/
--rw-r--r--   0 runner    (1001) docker     (123)     1074 2023-04-09 06:26:11.000000 hugg-0.0.74/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)      490 2023-04-09 06:26:24.839536 hugg-0.0.74/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)       34 2023-04-09 06:26:11.000000 hugg-0.0.74/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-09 06:26:24.835536 hugg-0.0.74/hugg/
--rw-r--r--   0 runner    (1001) docker     (123)    35833 2023-04-09 06:26:11.000000 hugg-0.0.74/hugg/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-09 06:26:24.839536 hugg-0.0.74/hugg.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)      490 2023-04-09 06:26:24.000000 hugg-0.0.74/hugg.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      182 2023-04-09 06:26:24.000000 hugg-0.0.74/hugg.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-04-09 06:26:24.000000 hugg-0.0.74/hugg.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       67 2023-04-09 06:26:24.000000 hugg-0.0.74/hugg.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)        5 2023-04-09 06:26:24.000000 hugg-0.0.74/hugg.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-04-09 06:26:24.839536 hugg-0.0.74/setup.cfg
--rwxr-xr-x   0 runner    (1001) docker     (123)     3533 2023-04-09 06:26:11.000000 hugg-0.0.74/setup.py
...
### Comparing `hugg-0.0.74/LICENSE` & `hugg-0.0.75/LICENSE`

 * *Files identical despite different names*

### Comparing `hugg-0.0.74/hugg/__init__.py` & `hugg-0.0.75/hugg/__init__.py`
...
### Comparing `hugg-0.0.74/setup.py` & `hugg-0.0.75/setup.py`
