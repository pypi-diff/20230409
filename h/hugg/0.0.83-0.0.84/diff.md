# Comparing `tmp/hugg-0.0.83.tar.gz` & `tmp/hugg-0.0.84.tar.gz`
...
## Comparing `hugg-0.0.83.tar` & `hugg-0.0.84.tar`
...
### Comparing `hugg-0.0.83/LICENSE` & `hugg-0.0.84/LICENSE`

 * *Files identical despite different names*

### Comparing `hugg-0.0.83/hugg/__init__.py` & `hugg-0.0.84/hugg/__init__.py`
...
### Comparing `hugg-0.0.83/setup.py` & `hugg-0.0.84/setup.py`
