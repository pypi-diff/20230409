# Comparing `tmp/tensorscout-2.1.0.tar.gz` & `tmp/tensorscout-2.2.0.tar.gz`
...
## Comparing `tensorscout-2.1.0.tar` & `tensorscout-2.2.0.tar`
...
### Comparing `tensorscout-2.1.0/LICENSE` & `tensorscout-2.2.0/LICENSE`

 * *Files identical despite different names*

### Comparing `tensorscout-2.1.0/README.md` & `tensorscout-2.2.0/README.md`

 * *Files identical despite different names*

### Comparing `tensorscout-2.1.0/setup.py` & `tensorscout-2.2.0/setup.py`
...
-'tensorscout', 'version': '2.1.0', 'description': 'A Python library for tensor
...
### Comparing `tensorscout-2.1.0/PKG-INFO` & `tensorscout-2.2.0/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: tensorscout Version: 2.1.0 Summary: A Python
