# Comparing `tmp/vandal-4.0.7.tar.gz` & `tmp/vandal-4.0.8.tar.gz`
...
### Comparing `vandal-4.0.7/PKG-INFO` & `vandal-4.0.8/PKG-INFO`
...
### Comparing `vandal-4.0.7/README.md` & `vandal-4.0.8/README.md`
